...
(function($) {
    ...
    kintone.events.on("app.record.index.show", function(e) {
        ...
        if( e.viewId != emxasConf.getConfig('VIEW_PRODUCTIVITY_ANALYSIS')) {return;}
        console.log("------");
    ...
    gridVal. GRID_TOP_COL_HEADERS =  [
                '<rowspan type="top"> </rowspan>',                      // 顧客コード（担当者コード）
    ...
    gridVal. getGridColumns = function(showType, sumFlg) {
        if (showType === '顧客別') {
            return  [
                {data: '顧客コード', type: 'text',  readOnly: true, renderer: colorRenderer},
                {data: '顧客名', type: 'text', readOnly: true , renderer: colorRenderer},
            ...
            return  [
                {data: '担当者コード', type: 'text',  readOnly: true, renderer: colorRenderer},
                {data: '担当者名', type: 'text', readOnly: true , renderer: colorRenderer},
                {data: '報酬', type: 'numeric', format: '0,0', readOnly: true, renderer: monetaryRenderer},
                {data: '工数', type: 'numeric', format: '0,0', readOnly: true, renderer: manHourRenderer,},
                {data: '時間あたり', type: 'numeric', format: '0,0', readOnly: true, renderer: monetaryRenderer},
                {data: '業務毎集計業務名称', type: 'text', readOnly: true},
        ...
        // let code = (showType === '顧客別')? '顧客コード': '担当者コード';
    ...
    gridVal. get2TermGridColumns = function(showType) {
        ...
        return  [
                    ...
                    {data: '工数', type: 'numeric', format: '0,0', renderer: manHourRenderer, readOnly: true,},
                    {data: '工数Comp', type: 'numeric', format: '0,0', renderer: manHourGainLossColorRenderer,  readOnly: true,},
                    {data: '時間あたり', type: 'numeric', format: '0,0', readOnly: true, renderer: monetaryRenderer},
                    {data: '時間あたりComp', type: 'numeric', format: '0,0', renderer: monetaryGainLossRenderer, readOnly: true,},
