...
(function($) {
  ...
  gridVal.GRID_COL_HEADERS = [
    ...
    '<rowspan type="top">売上数量<br>（本）</rowspan>',
    '<rowspan type="top">総重量<br>（kg）</rowspan>',
    '<rowspan type="top">売上金額</rowspan>',
    '<rowspan type="top">スプレッド</rowspan>',
    '<rowspan type="top">粗利金額</rowspan>',
    '<rowspan type="top">（運賃）</rowspan>',
    '<rowspan type="top">構成比</rowspan>',
    '<rowspan type="top">累積<br>構成比</rowspan>',
    '<rowspan type="top">販価<br>円/kg</rowspan>',
    '<rowspan type="top">運賃<br>/kg</rowspan>',
    '<rowspan type="top">置場販価<br>/kg</rowspan>',
    '<rowspan type="top">粗利率</rowspan>',
    '<rowspan type="top">粗利益<br>/kg</rowspan>',
